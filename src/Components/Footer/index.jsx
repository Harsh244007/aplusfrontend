    ...
    <Box className="mainFooter" as="section" bg={'#001620'} color={'#fff'}>
      <Container as={Stack} maxW={'6xl'} py={10}>
        <Box className="boxmainFooter">
          <Stack spacing={6}>
            <Box display="flex" marginBottom="20px" flexDir="column" gap="10px">
              <Link to="/">
                <Heading className="mainNameFooter">A-Plus Audios</Heading>
              </Link>
            ...
            <a href="tel:011-46595499">
              <ListHeader className="listheader">
                <TbDeviceLandlinePhone />
                011-46595499
              </ListHeader>
            </a>
            <a href="mailto:Sound_solutions2002@yahoo.com">
              <ListHeader className="listheader">
                <AiOutlineMail />
                sound_solutions2002@yahoo.com
              </ListHeader>
            </a>
          </Stack>
          <Box className="midboxFooter">
            <Heading className="mainNameFooter">Quick Links</Heading>
            <Box className="midboxFooter2">
            ...
            <Stack direction={'row'} spacing={6}>
              <SocialButton
                label={'FaceBook'}
                href={
                  'https://www.facebook.com/people/A-PlusAudios/100066704751923/'
                }
              >
                <FaTwitter />
              </SocialButton>
              <SocialButton
                label={'Whatsapp'}
                href={
                  'https://www.linkedin.com/in/aplus-audios-b6855266/?originalSubdomain=in'
                }
              >
                <FaLinkedinIn />
              </SocialButton>
              <SocialButton
                label={'Instagram'}
                href={'https://www.instagram.com/aplusaudiosofficial/'}
              >
                <FaInstagram />
              </SocialButton>
            </Stack>
          ...
          <Stack align={'flex-start'}>
            <Heading className="mainNameFooter">Location</Heading>
            <a
              href="https://goo.gl/maps/kKnrDcwoHv8fyPwq7"
              className="mapsFooterloca"
              target="_blank"
            >
              <Text className="addressfooter">
                Sound Solutions, Shed No. 24, DSIDC, Scheme III, Okhla
                Industrial Area, Phase II, New Delhi - 110020
              </Text>
            </a>
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3505.1314804564545!2d77.27424421517617!3d28.535767495204457!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390ce3ab40d5e241%3A0x1e0f5c07e67be737!2sSound%20Solutions!5e0!3m2!1sen!2sin!4v1678261451281!5m2!1sen!2sin"
              className="mapsFooter"
              loading="lazy"
            ></iframe>
          </Stack>
        </Box>

        {/* <Text className="footersublast" fontSize={'sm'}>
